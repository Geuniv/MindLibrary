...
public class BookService implements IBookService {
    ...
    public BookDTO getBook(String title) throws Exception {
        ...
        log.info(this.getClass().getName() + ".service 네이버 책 검색 API 호출 시작 !");
        ...
        BookDTO rDTO = naverAPIService.bookSearch(query, display, sort);

         // 응답에서 첫 번째 책 정보를 반환
        if (rDTO != null && rDTO.getItems() != null && !rDTO.getItems().isEmpty()) {

            log.info(this.getClass().getName() + ".service 네이버 책 검색 API 호출 끝 !");
            return rDTO;
        } else {
